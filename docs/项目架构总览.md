...
| replication transport 和服务端权威联机 | `snt_network` 已实现 TCP reliable + UDP unreliable、wire codec、主线程 tick 编排和 Steam P2P adapter；gameplay command/snapshot/delta/认证仍待实现 |
| 音频 | 未实现 |
