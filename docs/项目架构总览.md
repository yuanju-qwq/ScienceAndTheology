...
| EnTT World、稳定 EntityGuid、基础组件和 `SystemScheduler` | 已实现；World 不再拥有系统 |
...
| 炉子 `MachineTickSystem`、配方快照和事件边界 | P7.2.1 已实现，主线程 capture、worker 分片计算、barrier 按 Guid 顺序写回 |
