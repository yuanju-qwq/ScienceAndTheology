...
日期：2026-06-19
平台：Windows x86_64
Godot：4.7 stable，headless/dummy renderer
GDExtension：Debug
宇宙模式：solar_system
固定种子：20260619
采样时长：15 秒
...
headless/dummy renderer 下 TPS = FPS（client 端每个 _process 调用一次 tick，无累积）；与图形客户端不可直接横向比较；后续应使用相同命令、构建类型和机器做趋势比较。

## 3. 首份结果

| 时间 | TPS | FPS | 静态内存 MiB | 节点数 | 可见 chunk | 排队 view | tracked chunk | 异步生成 | mesh 数 | mesh 平均 ms | mesh 最大 ms |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 5.11s | 20 | 20 | 133.50 | 9,579 | 2 | 410 | 477 | 133 | 239 | 16.01 | 36.88 |
| 10.12s | 16 | 16 | 144.35 | 11,070 | 2 | 1,157 | 901 | 256 | 451 | 18.06 | 55.26 |
| 15.04s | 17 | 17 | 156.76 | 12,792 | 2 | 1,281 | 1,241 | 159 | 621 | 19.60 | 69.90 |
