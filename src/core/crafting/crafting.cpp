...
void CraftingManager::register_basic_recipes() {
    ...
    // ========================================================
    // Category: "materials" — compression / decompression
    // ========================================================
    ...
    // Nugget ↔ Ingot (9 nuggets = 1 ingot).
    ...
    // Dust → Block (4 dust = 1 block, for gem/dust materials).
    ...
    if (iron_ingot != kInvalidItemId && stick != kInvalidItemId) {
        // Hammer: 3 iron ingots + 2 sticks (3×2).
        ...
        // Wrench: 3 iron ingots in L-shape (2×2).
        ...
        // Screwdriver: iron ingot + stick (2×1).
        add_recipe(shaped("craft_screwdriver", "tools", 1, 2,
            {iron_ingot, stick},
            {1, 1},
            GT_SCREWDRIVER, 1));

        // Crowbar: 2 iron ingots + stick (3×2).
        ...
        // Saw: iron ingot + iron plate + stick (3×2).
    ...
    // Soft Mallet: 3 wood planks + 2 sticks (3×2).
    ...
    // Hard Hammer: iron block + 2 sticks (3×2).
    ...
    // ========================================================
    // Category: "parts" — basic component parts
    // ========================================================
    ...
    // ========================================================
    // Category: "wires" — wire cutting
    // ========================================================

    // Copper wire: wire_cutter + copper ingot → 2 copper wire.
    ...
    // ========================================================
    // Category: "cables" — insulated cables
    // ========================================================
    ...
    // ========================================================
    // Category: "circuits" — electronic components
    // ========================================================
    ...
    // ========================================================
    // Category: "machines" — machine blocks & components
    // ========================================================

    // Basic Machine Hull: 8 iron plates in a ring (3×3).
    if (iron_plate != kInvalidItemId) {
    ...
    // Advanced Machine Hull: 8 steel plates in a ring (3×3).
    ...
    // LV Electric Motor: 2 iron rod + 2 copper wire + iron (2×2).
    ...
    // Empty Fluid Cell: 4 tin plates (2×2).
    ...
    // Stone Plate: hammer + stone → stone plate.
    ...
    // Wood Planks: saw + wood log → 4 wood planks.
    ...
    // Sticks: 2 wood planks → 4 sticks (2×2 shaped).
    if (wood_plank != kInvalidItemId && stick != kInvalidItemId) {
    ...
    // Coal Block: 9 coal → 1 coal block (3×3 shaped).
    ItemId coal_gem = id("coal", MaterialForm::GEM);
    ItemId coal_block = id("coal", MaterialForm::BLOCK);
    ...
    // Firebrick: 4 brick + 1 coal dust → 1 firebrick (shapeless).
