...
// ============================================================
// Crafting recipe â€?manual, no power, instant
// ============================================================

// A manual crafting recipe for workbench (3Ã—3 grid) or inventory (2Ã—2).
// Two types:
...
struct CraftingRecipe {
    ...
    int grid_height = 0;
    ItemId pattern[9] = {};             // flattened 3Ã—3 grid (row-major)
...
// ============================================================
// Crafting grid â€?3Ã—3 workbench or 2Ã—2 inventory grid
// ============================================================
...
// ============================================================
// Crafting manager â€?recipe registry + matching
// ============================================================
