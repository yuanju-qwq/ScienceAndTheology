...
//   LOD 3 — very far: low-poly sphere
//   LOD 4 — extreme range / deep space: billboard (camera-facing quad)
...
public:
    ...
    //   lod_level: current LOD level (0-4)
