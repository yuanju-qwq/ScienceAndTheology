...
const GAS        := GEN_CELL
const FLUID_PLASMA := GEN_CELL | GEN_PLASMA
const GAS_PLASMA := GEN_CELL | GEN_PLASMA
...
static func register_all() -> void:
	for i in range(_ALL_MATERIALS.size()):
		var entry: Dictionary = (_ALL_MATERIALS[i] as Dictionary).duplicate()
		entry["id"] = i
...
{"name": "coal",     "title_key": "material.coal",     "gen_flags": DUST_ONLY | GEN_GEM | GEN_BLOCK, "state": SOLID, "color": 0x1A1A1A, "melting_point": 0,    "boiling_point": 0,   "mass": 1.0,  "chemical_formula": "C",        "elements": []},
...
{"name": "wood", "title_key": "material.wood", "gen_flags": DUST_ONLY | GEN_PLATE | GEN_ROD | GEN_BLOCK, "state": SOLID, "color": 0x8B5E3C, "melting_point": 0, "boiling_point": 0, "mass": 0.5, "chemical_formula": "C6H10O5", "elements": []},
...
{"name": "sulfur",     "title_key": "material.sulfur",     "gen_flags": DUST_ONLY | GEN_BLOCK, "state": SOLID, "color": 0xC0C040, "melting_point": 388,  "boiling_point": 718,  "mass": 32.1,  "chemical_formula": "S",  "elements": [{"element": "S", "count": 1}]},
...
{"name": "saltpeter",         "title_key": "material.saltpeter",         "gen_flags": DUST_ONLY | GEN_BLOCK, "state": SOLID, "color": 0xF0F0F0, "melting_point": 607,  "boiling_point": 0,    "mass": 101.1, "chemical_formula": "KNO3",      "elements": [{"element": "K", "count": 1}, {"element": "N", "count": 1}, {"element": "O", "count": 3}]},
...
{"name": "glass",              "title_key": "material.glass",              "gen_flags": DUST_ONLY | GEN_PLATE | GEN_BLOCK, "state": SOLID, "color": 0xE0E8F0, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "SiO2+Na2O+CaO",   "elements": []},
{"name": "borosilicate_glass", "title_key": "material.borosilicate_glass", "gen_flags": DUST_ONLY | GEN_PLATE | GEN_BLOCK, "state": SOLID, "color": 0xE0E8F0, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "SiO2+B2O3",      "elements": []},
...
{"name": "redstone",           "title_key": "material.redstone",           "gen_flags": DUST_ONLY | GEN_BLOCK, "state": SOLID, "color": 0xB01010, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "?", "elements": []},
{"name": "rubber",             "title_key": "material.rubber",             "gen_flags": GEN_PLATE, "state": SOLID, "color": 0x202020, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "(C5H8)n", "elements": [{"element": "C", "count": 5}, {"element": "H", "count": 8}]},
{"name": "polyethylene",       "title_key": "material.polyethylene",       "gen_flags": GEN_PLATE, "state": SOLID, "color": 0xE8F2F4, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "(C2H4)n", "elements": [{"element": "C", "count": 2}, {"element": "H", "count": 4}]},
{"name": "glowstone",          "title_key": "material.glowstone",          "gen_flags": DUST_ONLY | GEN_BLOCK, "state": SOLID, "color": 0xFFD65A, "melting_point": 0, "boiling_point": 0, "mass": 0, "chemical_formula": "?", "elements": []},
{"name": "wrought_iron",       "title_key": "material.wrought_iron",       "gen_flags": METAL_FULL, "state": SOLID, "color": 0x8A8580, "melting_point": 1811, "boiling_point": 3134, "mass": 55.8, "chemical_formula": "Fe", "elements": [{"element": "Fe", "count": 1}]},
]
...
const _ALL_COMPOUNDS := [
	...
	# Pure elements (IDs 147-182) now drop their realistic ore compound.
...
# New element constants (IDs 147-182) are available via C++ materials:: namespace
