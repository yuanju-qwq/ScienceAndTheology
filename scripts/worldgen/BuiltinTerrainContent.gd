...
static func _register_builtin_tile_mappings(registry: GDTerrainContentRegistry) -> void:
	var mappings := [
		...
		{ "material_key": "snt:stone", "layer": "underground", "source_id": 0, "atlas": Vector2i(3, 3), "variant_count": 1 },
		...
		{ "material_key": "snt:water", "layer": "underground", "source_id": 0, "atlas": Vector2i(8, 0), "variant_count": 1 },
		{ "material_key": "snt:lava", "layer": "surface", "source_id": 0, "atlas": Vector2i(9, 0), "variant_count": 1 },
		{ "material_key": "snt:lava", "layer": "underground", "source_id": 0, "atlas": Vector2i(9, 0), "variant_count": 1 },
