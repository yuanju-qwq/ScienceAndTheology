...
//   GameChunk chunk = gen.generate_chunk("overworld", 0, 0, 0);
...
public:
    ...
    // Returns a game-owned terrain chunk plus persistent sidecar data.
    GameChunk generate_chunk(const std::string& dimension_id,
