...
int global_coord(int chunk_coord, int local_coord) {
    return chunk_coord * VoxelChunk::kChunkSize + local_coord;
}
...
GameChunk TerrainGenerator::generate_chunk(
    ...
    chunk.terrain.resize(
        VoxelChunk::kChunkSize, VoxelChunk::kChunkSize, VoxelChunk::kChunkSize);
