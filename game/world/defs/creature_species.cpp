...
const CreatureSpeciesRegistry& builtin_creature_species() {
    static const CreatureSpeciesRegistry catalog = [] {
        ...
        add({
            ...
            .move_speed = 0.18f,
            .base_health = 0.9f,
            .player_detection_radius = 10.0f,
            .player_attack_range = 1.4f,
            .player_attack_damage = 3.0f,
        ...
        add({
            ...
            .move_speed = 0.14f,
            .base_health = 1.0f,
            .player_detection_radius = 12.0f,
            .player_attack_range = 2.0f,
            .player_attack_damage = 4.0f,
            .player_attack_cooldown_ticks = 20,
            .wander_radius = 10.0f,
            .model_scale = 1.3f,
            .biomes = {3},
        ...
        add({
            ...
            .move_speed = 0.10f,
            .base_health = 1.2f,
            .player_detection_radius = 9.0f,
            .player_attack_range = 1.5f,
            .player_attack_damage = 4.0f,
            .player_attack_cooldown_ticks = 20,
            .wander_radius = 8.0f,
            .model_scale = 1.4f,
        ...
        add({
            ...
            .base_health = 1.5f,
            .player_detection_radius = 10.0f,
            .player_attack_range = 1.6f,
            .player_attack_damage = 5.0f,
            .player_attack_cooldown_ticks = 20,
            .wander_radius = 12.0f,
            .model_scale = 1.0f,
            .drops = {
        ...
        add({
            ...
            .base_health = 2.0f,
            .player_detection_radius = 10.0f,
            .player_attack_range = 1.7f,
            .player_attack_damage = 6.0f,
            .player_attack_cooldown_ticks = 20,
            .wander_radius = 10.0f,
            .model_scale = 1.2f,
            .drops = {
